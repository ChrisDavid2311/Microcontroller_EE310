...
#define OUTPUT 0
#define BlinkLED_LAT   LATCbits.LATC2
#define WdtLED_LAT     LATCbits.LATC3
#define PORT_DIR       TRISC
#define ANSEL_PORT     ANSELC
...
void main(void)
{
    ...
    while(1)
{
     // after 10 seconds, read potentiometer
    ADCON0bits.GO = 1;
    while(ADCON0bits.GO);
    ...
    __delay_ms(2000);   // show recorded value
