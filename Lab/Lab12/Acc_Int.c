/*
 * The purpose of this program is demonstrate ADC Fuction For Motion Using Accelerometer
 * Connect your Accelerometer input to RA0. 
 ...
 * RC2 Interrupt
 * RD3 Interrupt LED
 * Acc & LCD Seperate Power
 * Power Consumption Check Using Nordic Power Profiler
 */
